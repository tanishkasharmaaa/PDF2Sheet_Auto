...
export const handleProPlanInvoice = async ({ user, senderEmail, file, spreadsheetId }) => {
  // 1️⃣ Convert PDF → Images → OCR
  let extractedText = "";
  try {
